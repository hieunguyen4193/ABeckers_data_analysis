...
path.to.main.input <- file.path(outdir, PROJECT, output.version, batch.id)
...
if (batch.id  == "batch1" & output.version == "default"){
  ...
  tsne.celltype.plot <- DimPlot(object = s.obj, reduction = "INTE_TSNE", group.by = "celltype", label = TRUE, label.box = TRUE, repel = TRUE)
  print(tsne.celltype.plot)
