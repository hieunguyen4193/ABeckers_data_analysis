---
title: "Integrate old and new datasets, `r params$output.version`"
author:
...
path.to.main.output <- file.path(path.to.main.input, output.version, "integrated_data")
path.to.03.output <- file.path(path.to.main.output, "03_output")
dir.create(path.to.03.output, showWarnings = FALSE, recursive = TRUE)

s.obj.batch1 <- readRDS(file.path(outdir, PROJECT, output.version, "batch1", "data_analysis", "01_output", "batch1.rds"))
s.obj.batch2 <- readRDS(file.path(outdir, PROJECT, output.version, "batch2", "data_analysis", "01_output", "batch2.rds"))
```
...
if (output.version == "default"){
  p <- DimPlot(object = s.obj, reduction = "INTE_TSNE", group.by = "celltype", label = TRUE, label.box = TRUE)
  print(p)
}
```
